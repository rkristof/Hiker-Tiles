...
class RouteGraph:
    ...
    def _shortest_highway_path(self, first_node, second_node, max_distance):
        ...
        predecessors = {}
        queue = [(0, first_node)]
        if not self._highway_index.contains_node(first_node):
            for node_id, point in self._highway_index.nodes_within_distance(
                first_point,
                max_distance,
            ):
        ...
        while queue:
            ...
            for (
                ...
                target_point,
                extension_distance,
            ) in self._highway_index.neighbors(current_node):
